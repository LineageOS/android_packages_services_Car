 ...
 */
public final class FakeRefactoredCarPowerManagementDaemon extends
        ICarPowerManagementDelegate.Default {
    private static final String TAG = FakeRefactoredCarPowerManagementDaemon.class.getSimpleName();
