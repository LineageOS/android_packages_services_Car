...
public class BaseLayoutInstaller {
    /**
     * Implementation of installBaseLayoutAround from {@link PluginFactoryOEMV4}
     */
    public static ToolbarControllerOEMV2 installBaseLayoutAround(
        ...
        ConstraintLayout baseLayout = (ConstraintLayout) LayoutInflater.from(pluginContext).inflate(
                layout, null, false);
        ...
        if (focusParkingViewFactory != null) {
            ...
            if (focusParkingView != null) {
                focusParkingView.setId(View.generateViewId());
        ...
        if (focusAreaFactory != null && toolbarEnabled) {
            ...
            focusArea.setId(View.generateViewId());
            if (focusArea != null) {
                ...
                constraintSet.connect(R.id.toolbar_tabs, ConstraintSet.TOP, focusArea.getId(),
                        ConstraintSet.BOTTOM, 0);

                FrameLayout containerParent = baseLayout.requireViewById(
                        R.id.base_layout_content_container_parent);
                constraintSet.connect(containerParent.getId(), ConstraintSet.TOP, focusArea.getId(),
                        ConstraintSet.BOTTOM, 0);
