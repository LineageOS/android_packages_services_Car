...
/**
 * Extension of {@link TextView} that supports text variants.
 */
public class VariantTextView extends AppCompatTextView {
    @NonNull
    private List<TextOEMV1> mText = Collections.emptyList();
    private OneShotPreDrawListener mOneShotPreDrawListener;

    public VariantTextView(Context context) {
        super(context);
    }

    public VariantTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public VariantTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * Set text to display.
     *
     * @param textList list of text to display. Each {@link TextOEMV1} in the list will be rendered
     *                 on a new line, separated by a line break
     */
    public void setText(@NonNull List<TextOEMV1> textList) {
        mText = requireNonNull(textList);
        asyncSetText(TextOEMV1.combineMultiLine(textList), true, Runnable::run);
    }

    /**
     * Set text to display.
     */
    public void setText(@NonNull TextOEMV1 text) {
    ...
    private CharSequence getBestVariant(TextOEMV1 text) {
