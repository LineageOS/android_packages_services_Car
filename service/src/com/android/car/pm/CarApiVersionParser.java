 ...
 *
 */
final class CarApiVersionParser {

    private static final String TAG = CarApiVersionParser.class.getSimpleName();
     ...
     */
    public static CarApiVersion getTargetCarApiVersion(ApplicationInfo info) {
        ...
        return parse(pkgName, info.metaData.getString(MANIFEST_METADATA_TARGET_CAR_API_VERSION),
                info.targetSdkVersion);
    }

    @VisibleForTesting
    static CarApiVersion parse(String pkgName, @Nullable String value, int targetSdkVersion) {
        if (value == null) {
            return CarApiVersion.forMajorAndMinorVersions(targetSdkVersion, 0);
        }
