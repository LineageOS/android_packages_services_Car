...
class CarShellCommand extends BasicShellCommandHandler {
    ...
    static {
        ...
        USER_BUILD_COMMAND_TO_PERMISSION_MAP.put(COMMAND_EMULATE_DRIVING_STATE,
                PERMISSION_CAR_TEST_SERVICE);
        USER_BUILD_COMMAND_TO_PERMISSION_MAP.put(COMMAND_INJECT_VHAL_EVENT,
                PERMISSION_CAR_TEST_SERVICE);
        USER_BUILD_COMMAND_TO_PERMISSION_MAP.put(COMMAND_INJECT_CONTINUOUS_EVENT,
                PERMISSION_CAR_TEST_SERVICE);
        USER_BUILD_COMMAND_TO_PERMISSION_MAP.put(COMMAND_INJECT_ERROR_EVENT,
                PERMISSION_CAR_TEST_SERVICE);
