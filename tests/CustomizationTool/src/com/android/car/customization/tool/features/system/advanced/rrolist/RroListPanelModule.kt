...
import com.android.car.customization.tool.features.system.advanced.submenu.SystemAdvancedMenu
...
internal class RroListPanelModule {
    ...
    fun provideRroListPanelLauncher(): MenuItem =
        MenuItem.PanelLauncher(
            displayTextRes = R.string.menu_system_advanced_rro_list_panel,
            isEnabled = true,
