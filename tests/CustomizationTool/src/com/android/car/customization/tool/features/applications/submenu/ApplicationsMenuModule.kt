...
package com.android.car.customization.tool.features.applications.submenu
...
/**
 * Qualifier used to provide elements to the Applications sub menu.
 */
@Qualifier
@Retention(AnnotationRetention.BINARY)
internal annotation class ApplicationsMenu

/**
 * Provides the Menu element for the RRO - Unbundled menu.
 */
@Module
internal class ApplicationsMenuModule {

    @Provides
    @IntoSet
    @RootMenu
    fun provideUnbundledRROMenu(
        @ApplicationsMenu items: Set<@JvmSuppressWildcards MenuItem>,
        @UIContext context: Context,
    ): MenuItem = MenuItem.SubMenuNavigation(
        displayTextRes = R.string.menu_applications,
