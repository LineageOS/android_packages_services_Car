...
package com.android.car.customization.tool.features.system.theme.submenu
...
/**
 * Qualifier used to provide elements to the System - Theme sub menu.
 */
@Qualifier
@Retention(AnnotationRetention.BINARY)
internal annotation class SystemThemeMenu

/**
 * Provides the Menu element for the RRO - SystemUi menu.
 */
@Module
internal class ThemeMenuModule {

    @Provides
    @IntoSet
    @SystemMenu
    fun provideSystemUiRroMenu(
        @SystemThemeMenu items: Set<@JvmSuppressWildcards MenuItem>,
        @UIContext context: Context,
    ): MenuItem = MenuItem.SubMenuNavigation(
        displayTextRes = R.string.menu_system_theme,
