...
package com.android.car.customization.tool.features.system.cutouts
...
import com.android.car.customization.tool.features.system.systembarpresets.SelectSystemBarPresetAction

internal fun cutoutsDropDownItem(overlayManager: OverlayManager): MenuItem.DropDown {
    val textRes = R.string.menu_system_cutouts_dropdown
        ...
        dropDownItems.add(
            MenuItem.DropDown.Item(
                ...
                action = SelectSystemBarPresetAction(
                    ...
                    packagesToDisable =
                        cutoutsConfiguration.minus(title).values.map { it.packageName }
                )
            )
        )
    }
