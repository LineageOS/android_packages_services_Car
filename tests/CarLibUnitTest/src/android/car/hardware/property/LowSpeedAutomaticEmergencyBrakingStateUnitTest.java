...
public class LowSpeedAutomaticEmergencyBrakingStateUnitTest {
    private final int mJavaConstantValue;
    private final int mHalConstantValue;

    public LowSpeedAutomaticEmergencyBrakingStateUnitTest(int javaConstantValue,
            int halConstantValue) {
