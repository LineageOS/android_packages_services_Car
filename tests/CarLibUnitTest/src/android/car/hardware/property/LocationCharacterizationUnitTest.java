...
public class LocationCharacterizationUnitTest {
    private final int mJavaConstantValue;
    private final int mHalConstantValue;

    public LocationCharacterizationUnitTest(int javaConstantValue, int halConstantValue) {
    ...
    public void testMatchWithVehicleHal() {
        assertWithMessage("Java constant")
            .that(mJavaConstantValue).isEqualTo(mHalConstantValue);
    }
}
