...
public final class CarPropertyEventCallbackControllerUnitTest {
    ...
    public void setUp() {
        ...
        mCarPropertyEventCallbackController =
                new CarPropertyEventCallbackController(
                        mContext, APP_TARGET_SDK, mCarPropertyEventCallback, DIRECT_EXECUTOR);
    }
    ...
    @Test
    public void testOnEvent_getPropertyStatus_notAvailable_sdkVersionBefore25Q4() {
        int vendorStatus = 0x1234;
        ...
        mCarPropertyEventCallbackController =
                new CarPropertyEventCallbackController(
                        mContext, appTargetSdk, mCarPropertyEventCallback, DIRECT_EXECUTOR);
    ...
    @Test
    public void testOnEvent_getPropertyStatus_error_sdkVersionBefore25Q4() {
        int vendorStatus = 0x1234;
        int appTargetSdk = Build.VERSION_CODES.BAKLAVA;
        when(mContext.checkSelfPermission(Car.PERMISSION_READ_PROPERTY_VENDOR_STATUS))
                .thenReturn(PackageManager.PERMISSION_DENIED);
