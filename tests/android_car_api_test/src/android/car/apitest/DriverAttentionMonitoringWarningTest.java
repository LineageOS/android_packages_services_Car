...
public class DriverAttentionMonitoringWarningTest {
    ...
    public DriverAttentionMonitoringWarningTest(int javaConstantValue, int halConstantValue) {
    ...
    public static Collection constantValues() {
        return Arrays.asList(
                new Object[][] {
                        {
                                android.car.hardware.property.DriverAttentionMonitoringWarning
                                        .OTHER,
                                android.hardware.automotive.vehicle.DriverAttentionMonitoringWarning
                                        .OTHER
                        },
                        {
                                android.car.hardware.property.DriverAttentionMonitoringWarning
