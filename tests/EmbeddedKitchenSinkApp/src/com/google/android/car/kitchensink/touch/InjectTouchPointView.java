 ...
 */
public final class InjectTouchPointView extends View {
    private static final String TAG = InjectTouchPointView.class.getSimpleName();
    ...
    private final List<Finger> mFingers = new ArrayList<Finger>();
