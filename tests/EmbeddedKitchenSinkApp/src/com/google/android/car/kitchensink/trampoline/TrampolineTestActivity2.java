...
public class TrampolineTestActivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityName.setText("TrampolineTestActivity2");

        Button backButton = findViewById(R.id.back_button);
        backButton.setOnClickListener(v -> finish());

        if (getIntent().getBooleanExtra(TrampolineFragment.DOUBLE_TRAMPOLINE_KEY, false)) {
            Intent intent = new Intent(this, TrampolineTestActivity3.class);
