...
#include "MockHidlEvsEnumerator.h"
...
class MockHidlEvsHal {
public:
    MockHidlEvsHal(size_t numCameras, size_t numDisplays) :
          mNumCameras(numCameras), mNumDisplays(numDisplays) {}
    ~MockHidlEvsHal();

    void initialize();
    ::android::sp<hidlevs::V1_1::IEvsEnumerator> getEnumerator();
...
private:
    ...
    ::android::sp<NiceMockHidlEvsEnumerator> mMockHidlEvsEnumerator;
    ...
    std::unordered_map<std::string, ::android::sp<hidlevs::V1_1::IEvsCameraStream>> mCameraClient;

    struct CameraRecord {
        hidlevs::V1_1::CameraDesc desc;
        ::android::wp<hidlevs::V1_1::IEvsCamera> activeInstance;

        CameraRecord(hidlevs::V1_1::CameraDesc& desc) : desc(desc) {}
    };
    ...
    std::map<hidlevs::V1_1::CameraParam, int32_t> mCameraParams;
    std::vector<hidlevs::V1_1::BufferDesc> mBufferPool GUARDED_BY(mLock);
    std::vector<hidlevs::V1_1::BufferDesc> mBuffersInUse GUARDED_BY(mLock);
