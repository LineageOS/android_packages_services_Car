...
#ifndef CPP_POWER_SERVER_SRC_POWERCOMPONENTHANDLER_H_
#define CPP_POWER_SERVER_SRC_POWERCOMPONENTHANDLER_H_
...
#endif  // CPP_POWER_SERVER_SRC_POWERCOMPONENTHANDLER_H_
