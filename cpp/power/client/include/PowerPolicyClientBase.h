...
#ifndef CPP_POWER_CLIENT_INCLUDE_POWERPOLICYCLIENTBASE_H_
#define CPP_POWER_CLIENT_INCLUDE_POWERPOLICYCLIENTBASE_H_
...
#endif  // CPP_POWER_CLIENT_INCLUDE_POWERPOLICYCLIENTBASE_H_
