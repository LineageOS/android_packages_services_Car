...
public static class VehicleHvacFanDirectionFlags {
public static final int VEHICLE_HVAC_FAN_DIRECTION_FACE_FLAG = 0x1;
public static final int VEHICLE_HVAC_FAN_DIRECTION_FLOOR_FLAG = 0x2;
public static final int VEHICLE_HVAC_FAN_DIRECTION_FACE_AND_FLOOR_FLAG = 0x3;
public static String enumToString(int v) {
switch(v) {
case VEHICLE_HVAC_FAN_DIRECTION_FACE_FLAG: return "VEHICLE_HVAC_FAN_DIRECTION_FACE_FLAG";
case VEHICLE_HVAC_FAN_DIRECTION_FLOOR_FLAG: return "VEHICLE_HVAC_FAN_DIRECTION_FLOOR_FLAG";
case VEHICLE_HVAC_FAN_DIRECTION_FACE_AND_FLOOR_FLAG: return "VEHICLE_HVAC_FAN_DIRECTION_FACE_AND_FLOOR_FLAG";
...
public static final int VEHICLE_AUDIO_FOCUS_REQUEST_RELEASE = 0x4;
public static String enumToString(int v) {
switch(v) {
...
public static class VehicleAppContextFlag {
public static final int VEHICLE_APP_CONTEXT_MUSIC_FLAG = 0x1;
public static final int VEHICLE_APP_CONTEXT_NAVIGATION_FLAG = 0x2;
public static final int VEHICLE_APP_CONTEXT_VOICE_COMMAND_FLAG = 0x4;
public static final int VEHICLE_APP_CONTEXT_CALL_FLAG = 0x8;
public static final int VEHICLE_APP_CONTEXT_ALARM_FLAG = 0x10;
public static final int VEHICLE_APP_CONTEXT_NOTIFICATION_FLAG = 0x20;
public static final int VEHICLE_APP_CONTEXT_UNKNOWN_FLAG = 0x40;
public static String enumToString(int v) {
switch(v) {
case VEHICLE_APP_CONTEXT_MUSIC_FLAG: return "VEHICLE_APP_CONTEXT_MUSIC_FLAG";
case VEHICLE_APP_CONTEXT_NAVIGATION_FLAG: return "VEHICLE_APP_CONTEXT_NAVIGATION_FLAG";
case VEHICLE_APP_CONTEXT_VOICE_COMMAND_FLAG: return "VEHICLE_APP_CONTEXT_VOICE_COMMAND_FLAG";
case VEHICLE_APP_CONTEXT_CALL_FLAG: return "VEHICLE_APP_CONTEXT_CALL_FLAG";
case VEHICLE_APP_CONTEXT_ALARM_FLAG: return "VEHICLE_APP_CONTEXT_ALARM_FLAG";
case VEHICLE_APP_CONTEXT_NOTIFICATION_FLAG: return "VEHICLE_APP_CONTEXT_NOTIFICATION_FLAG";
case VEHICLE_APP_CONTEXT_UNKNOWN_FLAG: return "VEHICLE_APP_CONTEXT_UNKNOWN_FLAG";
default: return "UNKNOWN";
}
}
}
...
case VEHICLE_SEAT_ROW_1_PASSENGER_1: return "VEHICLE_SEAT_ROW_1_PASSENGER_1";
case VEHICLE_SEAT_ROW_1_PASSENGER_2: return "VEHICLE_SEAT_ROW_1_PASSENGER_2";
case VEHICLE_SEAT_ROW_1_PASSENGER_3: return "VEHICLE_SEAT_ROW_1_PASSENGER_3";
case VEHICLE_SEAT_ROW_2_PASSENGER_1: return "VEHICLE_SEAT_ROW_2_PASSENGER_1";
case VEHICLE_SEAT_ROW_2_PASSENGER_2: return "VEHICLE_SEAT_ROW_2_PASSENGER_2";
case VEHICLE_SEAT_ROW_2_PASSENGER_3: return "VEHICLE_SEAT_ROW_2_PASSENGER_3";
case VEHICLE_SEAT_ROW_3_PASSENGER_1: return "VEHICLE_SEAT_ROW_3_PASSENGER_1";
case VEHICLE_SEAT_ROW_3_PASSENGER_2: return "VEHICLE_SEAT_ROW_3_PASSENGER_2";
case VEHICLE_SEAT_ROW_3_PASSENGER_3: return "VEHICLE_SEAT_ROW_3_PASSENGER_3";
default: return "UNKNOWN";
}
}
}
