...
public final class CarPropertyErrorCodes implements Parcelable {
    ...
    /** Creates a clone of the {@link CarPropertyErrorCodes} without the vendor error code. */
    public CarPropertyErrorCodes cloneWithVendorErrorCodeFiltered() {
        return new CarPropertyErrorCodes(
                mCarPropertyManagerErrorCode, /* vendorErrorCode= */ 0, mSystemErrorCode);
    }
