...
public final class CommonConstants {
    ...
    public static final int USER_LIFECYCLE_EVENT_TYPE_POST_STARTING = 7;
    public static final int USER_LIFECYCLE_EVENT_TYPE_POST_SWITCHING = 8;
    public static final int USER_LIFECYCLE_EVENT_TYPE_POST_UNLOCKED = 9;
    ...
    @IntDef(prefix = { "USER_LIFECYCLE_EVENT_TYPE_" }, value = {
            ...
            USER_LIFECYCLE_EVENT_TYPE_POST_STARTING,
            USER_LIFECYCLE_EVENT_TYPE_POST_SWITCHING,
