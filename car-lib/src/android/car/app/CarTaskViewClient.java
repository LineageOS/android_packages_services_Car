...
public final class CarTaskViewClient {
    ...
    /** Returns the current bounds on screen for the task view's view part. */
     ...
     * int)}
     */
    public void setResizeBackgroundColor(SurfaceControl.Transaction transaction, int color) {
        try {
